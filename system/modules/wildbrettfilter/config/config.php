...
(
	'wildbrett' => array 
	(
		'wildbrettfilter' => array
		(
			'tables'	=> array('tl_wildbrettfilter'),
			'icon'		=> 'system/modules/wildbrettfilter/assets/images/wildbrettfilter_icon.png'
		)
	)	
));
...
array_insert($GLOBALS['FE_MOD']['application'], 0, array (
    ...
    'wildbrettfilter' => 'ModulWildbrettFilter'
));
