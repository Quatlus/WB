...
(
	...
	(
		'wildbrettshop' => array
		(
			'tables'	=> array('tl_wildbrettshop_archiv','tl_wildbrettshop'),
			'icon'		=> 'system/modules/wildbrettshop/assets/images/wildbrettshop_icon.png'
		)
	)	
));
...
array_insert($GLOBALS['FE_MOD']['application'], 0, array (
    ...
    'wildbrettshop' => 'ModulWildbrettShop'
));
