...
(
	'wildbrett' => array 
	(
		'wildbrettfarben' => array
		(
			'tables'	=> array('tl_wildbrettfarben'),
			'icon'		=> 'system/modules/wildbrettfarben/assets/images/wildbrettfarben_icon.png'
		)
	)	
));
...
array_insert($GLOBALS['FE_MOD']['application'], 0, array (
    ...
    'wildbrettfarben' => 'ModulWildbrettFarben'
));
